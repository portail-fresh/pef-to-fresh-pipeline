...
from pipeline.utils.XmlChangelog import XmlChangelog
...
class FieldTransformer:
    ...
    def __init__(self, excel_path: str, file_id: str, changelog: XmlChangelog, task_name:str):
        """
    ...
    def _apply_add(self, op: Dict[str, Any], root: etree._Element):
        ...
        for parent in parent_nodes:
            ...
            new_elem.text = str(to_val)
            parent.append(new_elem)
            self.changelog.log_add(self.task_name, op["to"]["xpath"], str(to_val))

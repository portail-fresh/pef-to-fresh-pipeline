...
def align_study_status(xml_file: str, input_folder: str, output_folder: str, context=None):
    """
    ...
    try:
        ...
        excel_path = "study-status-regles-migration.xlsx"
        task_name = "align_study_status"

...
def add_rare_diseases(xml_file: str, input_folder: str, output_folder: str, context=None):
    """
    ...
    try:
        ...
        excel_path = "rare-diseases-repartition.xlsx"
        task_name = "add_rare_diseases"

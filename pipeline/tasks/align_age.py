...
def align_age(xml_file: str, input_folder: str, output_folder: str, context=None):
    """
    Applies general field replacements for age alignment in the given XML file
    using 'align-age.xlsx' as mapping table.
    ...
    try:
        ...
        if logger:
            logger.info("Starting age alignment transformation for file: %s", xml_file)
        ...
        if logger:
            logger.info("Successfully applied age alignment transformation and saved: %s", output_path)

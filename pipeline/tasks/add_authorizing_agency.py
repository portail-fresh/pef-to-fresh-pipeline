...
def add_authorizing_agency(xml_file: str, input_folder: str, output_folder: str, context=None):
    """
    ...
    try:
        ...
        excel_path = "auth-agency-repartition.xlsx"
        task_name = "add_authorizing_agency"

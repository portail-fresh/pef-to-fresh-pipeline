...
def align_biobank_content(xml_file: str, input_folder: str, output_folder: str, context=None):
    """
    ...
    try:
        ...
        excel_path = "align-biobank-content-fr-en.xlsx"
        task_name = "align_biobank_content"
